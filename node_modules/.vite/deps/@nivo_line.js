...
var te = function(e3) {
  var i3 = e3.slice, r3 = e3.axis, n3 = Vt(), o3 = "x" === r3 ? "y" : "x";
  return (0, import_jsx_runtime2.jsx)(C, { rows: i3.points.map(function(e4) {
    return [(0, import_jsx_runtime2.jsx)(b, { color: e4.serieColor, style: n3.tooltip.chip }, "chip"), e4.serieId, (0, import_jsx_runtime2.jsx)("span", { style: n3.tooltip.tableCellValue, children: e4.data[o3 + "Formatted"] }, "value")];
  }) });
};
...
var le = re({}, se, { enablePointLabel: import_prop_types.default.bool.isRequired, role: import_prop_types.default.string.isRequired, useMesh: import_prop_types.default.bool.isRequired }, et, kt);
...
var be = function(e3) {
  var o3 = e3.data, t3 = e3.xScale, a2 = void 0 === t3 ? ce.xScale : t3, s2 = e3.xFormat, l2 = e3.yScale, d = void 0 === l2 ? ce.yScale : l2, c = e3.yFormat, f2 = e3.width, p2 = e3.height, h = e3.colors, b3 = void 0 === h ? ce.colors : h, g2 = e3.curve, m = void 0 === g2 ? ce.curve : g2, v2 = e3.areaBaselineValue, x2 = void 0 === v2 ? ce.areaBaselineValue : v2, R = e3.pointColor, q = void 0 === R ? ce.pointColor : R, O2 = e3.pointBorderColor, M = void 0 === O2 ? ce.pointBorderColor : O2, C3 = e3.enableSlices, S2 = void 0 === C3 ? ce.enableSlicesTooltip : C3, T2 = Xt(s2), w3 = Xt(c), L = pr(b3, "id"), W = Vt(), G = We(q, W), P3 = We(M, W), E = (0, import_react2.useState)([]), j = E[0], F = E[1], V2 = (0, import_react2.useMemo)(function() {
    return dn(o3.filter(function(e4) {
      return -1 === j.indexOf(e4.id);
    }), a2, d, f2, p2);
  }, [o3, j, a2, d, f2, p2]), Y = V2.xScale, D = V2.yScale, X3 = V2.series, z = (0, import_react2.useMemo)(function() {
  ...
  }, [o3, X3, L]), A = z.legendData, H2 = z.series, I = (0, import_react2.useCallback)(function(e4) {
    F(function(i3) {
  ...
  }({ series: H2, getPointColor: G, getPointBorderColor: P3, formatX: T2, formatY: w3 }), N2 = ye({ enableSlices: S2, points: K2, width: f2, height: p2 });
  return { legendData: A, toggleSerie: I, lineGenerator: pe({ curve: m }), areaGenerator: he({ curve: m, yScale: D, areaBaselineValue: x2 }), getColor: L, series: H2, xScale: Y, yScale: D, slices: N2, points: K2 };
};
var ge = function(e3) {
  var i3 = e3.areaBlendMode, r3 = e3.areaOpacity, n3 = e3.color, o3 = e3.fill, t3 = e3.path, a2 = tt(), s2 = a2.animate, l2 = a2.config, u = it2(t3), d = J({ color: n3, config: l2, immediate: !s2 });
  return (0, import_jsx_runtime2.jsx)(it.path, { d: u, fill: o3 || d.color, fillOpacity: r3, strokeWidth: 0, style: { mixBlendMode: i3 } });
};
...
var xe = function(e3) {
  ...
  return (0, import_jsx_runtime2.jsx)(it.path, { d: s2, fill: "none", strokeWidth: t3, stroke: o3 });
};
...
var Me = function(e3) {
  var i3 = e3.slice, r3 = e3.axis, t3 = e3.debug, a2 = e3.tooltip, s2 = e3.isCurrent, l2 = e3.setCurrent, u = e3.onMouseEnter, d = e3.onMouseMove, c = e3.onMouseLeave, f2 = e3.onClick, p2 = k(), h = p2.showTooltipFromEvent, y = p2.hideTooltip, b3 = (0, import_react2.useCallback)(function(e4) {
    h((0, import_react2.createElement)(a2, { slice: i3, axis: r3 }), e4, "right"), l2(i3), u && u(i3, e4);
  }, [h, a2, i3, u]), g2 = (0, import_react2.useCallback)(function(e4) {
  ...
  return (0, import_jsx_runtime2.jsx)("rect", { x: i3.x0, y: i3.y0, width: i3.width, height: i3.height, stroke: "red", strokeWidth: t3 ? 1 : 0, strokeOpacity: 0.75, fill: "red", fillOpacity: s2 && t3 ? 0.35 : 0, onMouseEnter: b3, onMouseMove: g2, onMouseLeave: m, onClick: v2, "data-testid": "slice-" + i3.id });
};
...
var we = function(e3) {
  var i3 = e3.points, r3 = e3.symbol, n3 = e3.size, o3 = e3.borderWidth, t3 = e3.enableLabel, a2 = e3.label, s2 = e3.labelYOffset, l2 = Vt(), d = Ei(a2), c = i3.slice(0).reverse().map(function(e4) {
  ...
  return (0, import_jsx_runtime2.jsx)("g", { children: c.map(function(e4) {
    return (0, import_jsx_runtime2.jsx)(Mi, { x: e4.x, y: e4.y, datum: e4.datum, symbol: r3, size: n3, color: e4.fill, borderWidth: o3, borderColor: e4.stroke, label: e4.label, labelYOffset: s2, theme: l2 }, e4.id);
  }) });
};
...
var Be = function(e3) {
  var i3 = e3.points, r3 = e3.width, t3 = e3.height, a2 = e3.margin, s2 = e3.setCurrent, l2 = e3.onMouseEnter, u = e3.onMouseMove, d = e3.onMouseLeave, c = e3.onClick, f2 = e3.tooltip, p2 = e3.debug, h = k(), y = h.showTooltipAt, b3 = h.hideTooltip, g2 = (0, import_react2.useCallback)(function(e4, i4) {
    ...
    b3(), s2(null), d && d(e4, i4);
  }, [b3, s2, d]), x2 = (0, import_react2.useCallback)(function(e4, i4) {
    c && c(e4, i4);
  }, [c]);
  return (0, import_jsx_runtime2.jsx)(P2, { nodes: i3, width: r3, height: t3, onMouseEnter: g2, onMouseMove: m, onMouseLeave: v2, onClick: x2, debug: p2 });
};
...
var Ee = function(e3) {
  var i3 = e3.width, t3 = e3.height, a2 = e3.margin, d = e3.pixelRatio, c = e3.data, f2 = e3.xScale, p2 = e3.xFormat, h = e3.yScale, y = e3.yFormat, b3 = e3.curve, g2 = e3.layers, m = e3.colors, v2 = e3.lineWidth, x2 = e3.enableArea, q = e3.areaBaselineValue, O2 = e3.areaOpacity, M = e3.enablePoints, C3 = e3.pointSize, w3 = e3.pointColor, k3 = e3.pointBorderWidth, B2 = e3.pointBorderColor, L = e3.enableGridX, W = e3.gridXValues, G = e3.enableGridY, j = e3.gridYValues, F = e3.axisTop, Y = e3.axisRight, D = e3.axisBottom, X3 = e3.axisLeft, A = e3.legends, H2 = e3.isInteractive, I = e3.debugMesh, J2 = e3.onMouseLeave, K2 = e3.onClick, Q2 = e3.tooltip, U = e3.canvasRef, Z = (0, import_react2.useRef)(null), $ = At(i3, t3, a2), ne2 = $.margin, oe2 = $.innerWidth, te2 = $.innerHeight, ae2 = $.outerWidth, se2 = $.outerHeight, le2 = Vt(), ue2 = (0, import_react2.useState)(null), de2 = ue2[0], ce2 = ue2[1], fe2 = be({ data: c, xScale: f2, xFormat: p2, yScale: h, yFormat: y, width: oe2, height: te2, colors: m, curve: b3, areaBaselineValue: q, pointColor: w3, pointBorderColor: B2 }), pe2 = fe2.lineGenerator, he2 = fe2.areaGenerator, ye2 = fe2.series, ge2 = fe2.xScale, me2 = fe2.yScale, ve2 = fe2.points, xe2 = x({ points: ve2, width: oe2, height: te2, debug: I }), Re2 = xe2.delaunay, qe2 = xe2.voronoi;
  (0, import_react2.useEffect)(function() {
    U && (U.current = Z.current), Z.current.width = ae2 * d, Z.current.height = se2 * d;
    var e4 = Z.current.getContext("2d");
    e4.scale(d, d), e4.fillStyle = le2.background, e4.fillRect(0, 0, ae2, se2), e4.translate(ne2.left, ne2.top), g2.forEach(function(i4) {
      if ("function" == typeof i4 && i4({ ctx: e4, innerWidth: oe2, innerHeight: te2, series: ye2, points: ve2, xScale: ge2, yScale: me2, lineWidth: v2, lineGenerator: pe2, areaGenerator: he2, currentPoint: de2, setCurrentPoint: ce2 }), "grid" === i4 && le2.grid.line.strokeWidth > 0 && (e4.lineWidth = le2.grid.line.strokeWidth, e4.strokeStyle = le2.grid.line.stroke, L && C2(e4, { width: oe2, height: te2, scale: ge2, axis: "x", values: W }), G && C2(e4, { width: oe2, height: te2, scale: me2, axis: "y", values: j })), "axes" === i4 && V(e4, { xScale: ge2, yScale: me2, width: oe2, height: te2, top: F, right: Y, bottom: D, left: X3, theme: le2 }), "areas" === i4 && true === x2 && (e4.save(), e4.globalAlpha = O2, he2.context(e4), ye2.forEach(function(i5) {
      ...
      })), "points" === i4 && true === M && C3 > 0 && ve2.forEach(function(i5) {
        e4.fillStyle = i5.color, e4.beginPath(), e4.arc(i5.x, i5.y, C3 / 2, 0, 2 * Math.PI), e4.fill(), k3 > 0 && (e4.strokeStyle = i5.borderColor, e4.lineWidth = k3, e4.stroke());
      }), "mesh" === i4 && true === I && (O(e4, qe2), de2 && S(e4, qe2, de2.index)), "legends" === i4) {
  ...
  }, [Z, ae2, se2, g2, le2, pe2, ye2, ge2, me2, L, W, G, j, F, Y, D, X3, A, ve2, M, C3, de2]);
  var Oe2 = (0, import_react2.useCallback)(function(e4) {
    var i4 = Qi(Z.current, e4), r3 = i4[0], n3 = i4[1];
    if (!Ji(ne2.left, ne2.top, oe2, te2, r3, n3))
      return null;
    ...
    Se2(), ce2(null), de2 && J2 && J2(de2, e4);
  }, [Se2, ce2, J2]), ke2 = (0, import_react2.useCallback)(function(e4) {
    if (K2) {
      var i4 = Oe2(e4);
      i4 && K2(i4, e4);
    }
